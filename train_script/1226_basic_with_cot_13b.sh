...
echo $ROOT_DIR
DATA_ARGS="--data_path /mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/data_config/train_gsm8k_direct.json"

output_dir="$ROOT_DIR/outputs/llama2-13B-gsm8k-normal-cot"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --tf32 True \
    --lazy_preprocess  >$ROOT_DIR/training_logs/1226_hcot_13b_basic_normal_cot.log