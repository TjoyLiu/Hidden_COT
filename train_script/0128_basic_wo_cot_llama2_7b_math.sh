...
output_dir="$ROOT_DIR/outputs/llama2-7B-math-without-cot-0128"
model_name_or_path="/mnt/pfs/zitao_team/big_model/raw_models/Llama-2-7b-hf"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --tf32 True \
    --lazy_preprocess >$ROOT_DIR/training_logs/0128_hcot_7b_without_cot_math.log
