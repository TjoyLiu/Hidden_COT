...
echo $ROOT_DIR
DATA_ARGS="--data_path /mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/data_config/train_gsm8k_direct_no_cot.json"

output_dir="$ROOT_DIR/outputs/llama2-13B-gsm8k-without-cot"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --deepspeed "/mnt/pfs/zitao_team/tianqiaoliu/Project/papers/hidden_cot/train_config/default_no_offload_param_stage_2.json" \
    --tf32 True \
    --lazy_preprocess >$ROOT_DIR/training_logs/1226_hcot_13b_basic_wo_cot.log