...
output_dir="$ROOT_DIR/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --lazy_preprocess True >$ROOT_DIR/training_logs/1226_hcot_llm_mse_10_bs_128_no_special.log
