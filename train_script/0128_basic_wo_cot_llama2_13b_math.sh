...
echo $ROOT_DIR
DATA_ARGS="--data_path /mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/data_config/train_math_direct_no_cot_0128.json"

output_dir="$ROOT_DIR/outputs/llama2-13B-math-without-cot-0128"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --deepspeed "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/COT_model_training/ds_zero2_no_offload.json" \
    --tf32 True \
    --lazy_preprocess >$ROOT_DIR/training_logs/0128_hcot_13b_without_cot_math.log
