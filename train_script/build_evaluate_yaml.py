...
model_paths = [
    {
        "model_name": "llama2-7B-gsm8k-normal-cot",
        "model_paths": [
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-normal-cot/checkpoint-180"
        ],
        "device_num": 1,
        "task_name": "llama2-7B-gsm8k-cot",
    },
    {
        "model_name": "llama2-7B-gsm8k-without-cot",
        "model_paths": [
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-without-cot/checkpoint-180"
        ],
        "device_num": 1,
        "task_name": "llama2-7B-gsm8k-wo-cot",
    },
    {
        "model_name": "llama2-13B-gsm8k-normal-cot",
        "model_paths": [
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-13B-gsm8k-normal-cot/checkpoint-180"
        ],
        "device_num": 1,
        "task_name": "llama2-13B-gsm8k-cot",
    },
    {
        "model_name": "llama2-13B-gsm8k-without-cot",
        "model_paths": [
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-13B-gsm8k-without-cot/checkpoint-180"
        ],
        "device_num": 1,
        "task_name": "llama2-13B-gsm8k-wo-cot",
    },
    {
        "model_name": "HCOT_7b_mse_10_bs_128_ckpt_100",
        "model_paths": [
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special/checkpoint-100",
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special/checkpoint-200",
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special/checkpoint-300",
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special/checkpoint-400",
            "/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/outputs/llama2-7B-gsm8k-hcot-llm-mse-10-bs-128-no-special/checkpoint-500",
        ],
        "device_num": 1,
        "task_name": "HCOT-7B-mse10-bs128",
    },
]
...
where_to_save_yaml = (
    "/mnt/pfs/zitao_team/tianqiaoliu/run_CCE_tasks/hcot_eval/first_batch"
)
