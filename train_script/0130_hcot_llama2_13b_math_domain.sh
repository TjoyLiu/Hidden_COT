...
model_name_or_path=/mnt/pfs/zitao_team/big_model/raw_models/Llama-2-13b-hf
data_path=/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/data_config/train_hcot_math_domain_0129.json
per_device_train_batch_size=1
gradient_accumulation_steps=4
model_max_length=2048
output_dir="$ROOT_DIR/outputs/llama2-13B-math-hcot-llm-mse-10-bs-128-0129"
hcot_config_path=/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/hcot_llm_model/config_math_llama2_13b_0129.json
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --lazy_preprocess True >$ROOT_DIR/training_logs/llama2_13b_math_hcot_llm_mse_10_bs_128_0129.log
