...
output_dir="$ROOT_DIR/outputs/llama2-7B-math-hcot-llm-mse-10-bs-128-0129"
hcot_config_path=/mnt/pfs/zitao_team/tianqiaoliu/Project/teammates/hidden_cot/train_script/hcot_llm_model/config_math_llama2_7b_0129.json
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --lazy_preprocess True >$ROOT_DIR/training_logs/llama2_7b_math_hcot_llm_mse_10_bs_128_0129.log
